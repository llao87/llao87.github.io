		...
		<div class="question-more-wrap js-question-more-wrap">
			<div class="faq-inner">
					...
					<div class="faq__row">
						<div class="faq__buble faq__buble--answer">
							<div id="fishing-process">
								<ul>
									<li class="show">
										<img class="fishing-process-img" src="img/faq/fishing-ivasi-1.svg"
										alt="" />
									</li>
									<li>
										<img class="fishing-process-img" src="img/faq/fishing-ivasi-2.svg" alt="" />
									</li>
									<li>
										<img class="fishing-process-img" src="img/faq/fishing-ivasi-3.svg" alt="" />
									</li>
								</ul>
							</div>
				...
				<div class="col-xl-10 col-xl-offset-2">
					<div class="faq__row">
						<img class="faq__avatar" src="img/user.svg" alt="аватар отзыва" />
						<div class="faq__buble faq__buble--question">А как все эти микроэлементы сохраняются в пресервах и чем эта упаковка отличается от консервов?</div>
					</div>
					...
					<div class="faq__row">
						<div class="faq__buble faq__buble--answer">
							...
							<p>Пресервы не подвергаются обработке высокими температурами в отличие от консервов. Срок хранения пресервов меньше, чем консервов, зато у рыбных пресервов более насыщенный вкус, в них сохранен максимум полезных веществ, к тому же поверхность рыбы не страдает.</p>
						</div>
				...
				<div class="col-xl-10 col-xl-offset-2" id="fish_bones">
					<div class="faq__row">
						<img class="faq__avatar" src="img/user.svg" alt="аватар отзыва" />
						<div class="faq__buble faq__buble--question">Есть ли в филе ИВАСИ кости? Можно ли кормить детей ИВАСИ?
						</div>
					</div>

					<div class="faq__row animated animated-scroll fast" data-animateClass="fadeInUp">
						<div class="faq__buble faq__buble--answer">
							<div id="otvet-kosti"></div>

							<p>Существует два пути удаления костей: химический и механический. Чтобы избежать использования химических веществ, мы удаляем их механически. Если и остаются какие-то небольшие косточки, то их можно съесть без дискомфорта, поскольку они гораздо мягче по сравнению с сельдью. Добавлять Иваси в рацион можно любому – здесь нет каких-либо возрастных ограничений.</p>
						</div>
				...
				<div class="col-xl-10 col-xl-offset-2">
					...
					<div class="faq__row animated animated-scroll fast" data-animateClass="fadeInUp">
						<div class="faq__buble faq__buble--answer">
							...
							<p>Рецептов с ИВАСИ множество: от традиционных советских блюд до современных рецептов со всего света. Следите за обновлениями в разделе <a class="go-to-recipes" href="/#recipes" data-target="recipes">«Рецепты»</a>
							</p>
						</div>
