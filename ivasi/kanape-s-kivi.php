            ...
            <div class="col col--half recipe-main-info">
                <div class="recipe recipe__info  animated slow fadeInRight">
                    ...
                    <div class="ingredients">
                        ...
                        <ul class="col col--half">
                            <li><span class="option-name">Киви</span><span
                                class="option-separator">–</span><span class="option-value">2 шт</span>
                            </li>
                            <li><span class="option-name">Сливочный сыр</span><span class="option-separator">–</span><span
                                class="option-value">100г</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="cooking-info animated animated-scroll slow" data-animateClass="fadeInLeft">
                    ...
                    <div class="cooking-step__description">Порежьте хлеб на небольшие кусочки. Смажьте его сливочным сыром
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="cooking-info animated animated-scroll slow" data-animateClass="fadeInRight">
                    ...
                    <div class="cooking-step__description">Порежьте киви тонкими ломтиками и выложите его на хлеб.
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="cooking-info animated animated-scroll slow" data-animateClass="fadeInLeft">
                    ...
                    <div class="cooking-step__description">Положите на каждый бутерброд по две филе ИВАСИ без кожи! Закуска готова!
                    </div>
